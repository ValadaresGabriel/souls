...
public class MoveBlockPreview
{
    static public MoveBlockPreview s_Preview = null;
    static public GameObject preview;

    static protected MoveBlock movingPlatform;

    static MoveBlockPreview()
    {
    ...
    static public void CreateNewPreview(MoveBlock origin)
    {
        if(preview != null)
        {
            Object.DestroyImmediate(preview);
        ...
        MoveBlock plt = preview.GetComponentInChildren<MoveBlock>();
